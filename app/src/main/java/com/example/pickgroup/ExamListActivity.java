...
public class ExamListActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout esamiLayout = (LinearLayout) findViewById(R.id.linearLayoutExameChooseExamList);
        ArrayList<String> esami = studenteLog.getEsami();
        for(String esame : esami) {
            final TextView exameView = new TextView(this);
            exameView.setText(esame);
            exameView.setHeight(110);
            exameView.setWidth(LinearLayout.LayoutParams.MATCH_PARENT);
            exameView.setPadding(40,15,0,0);
            exameView.setTextColor(Color.BLACK);
            exameView.setTextSize(18);
            exameView.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
            esamiLayout.addView(exameView);
        }

        Button buttonHome = (Button) findViewById(R.id.buttonHomeExamList);
        buttonHome.setOnClickListener( new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent openHome = new Intent(ExamListActivity.this, ProfileActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        ImageView imgProfiloMenu = (ImageView) findViewById(R.id.imageViewProfiloExamList);
        ...
        TextView textNameSurnameMenu = (TextView) findViewById(R.id.textViewNameSurnameExamList);
        ...
        TextView textMatricolaMenu = (TextView) findViewById(R.id.textViewMatricolaExamList);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_exam_list_profile) {
            ...
            return true;
        } else if (id == R.id.nav_exam_list_search_exams) {
        ...
        } else if (id == R.id.nav_exam_list_search_group) {
        ...
        } else if (id == R.id.nav_exam_list_search_student) {
            ...
            return true;
        } else if (id == R.id.nav_exam_list_settings) {
            /*
            Intent intent = new Intent(this, SettingActivity.class);
            this.startActivity(intent);
            return true;
            */
        } else if(id == R.id.nav_exam_list_logout){
